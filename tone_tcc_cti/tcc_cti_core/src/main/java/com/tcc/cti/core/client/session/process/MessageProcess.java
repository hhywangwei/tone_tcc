...
import com.tcc.cti.core.client.session.process.handler.ReceiveCollectionHandler;
import com.tcc.cti.core.client.session.process.handler.ReceiveHandlerable;
import com.tcc.cti.core.client.session.process.handler.SendCollectionHandler;
