       ...
       <table width="1000" cellpadding="0" align="center" cellspacing="0" border="0" height="100%">
         <tr>
              ...
              <table width="100%" cellpadding="0" cellspacing="0" border="0" height="100%">
                ...
                <tr>
                  <td height="100%" class="left_bg">
                     <iframe src='<c:url value="left_zx.jsp"/>' frameborder="0" scrolling="no" width="170" height="100%" allowTransparency="true"></iframe>
                  </td>
                </tr>
                <tr>
           ...
           <td width="820" valign="top" height="100%" style="padding-top:10px;">
              <iframe src='<c:url value="right_zx.jsp"/>' frameborder="0" scrolling="auto" height="100%" width="100%" allowTransparency="true"></iframe>
           </td>
         </tr>
       </table>
    </td>
